...
#ifndef _PIFO_MAIN_LENGTHAWAREQUEUE_H_
#define _PIFO_MAIN_LENGTHAWAREQUEUE_H_
 ...
 */
class PIFOLengthAwareQueue: public LengthAwareQueue {
protected:
    /**
...
//    cMessage requestPacketMsg = cMessage("requestPacketPifo");
