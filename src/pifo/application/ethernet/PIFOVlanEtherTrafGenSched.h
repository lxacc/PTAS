...
#ifndef __PIFO_VETHERTRAFGENSCHED_H
#define __PIFO_VETHERTRAFGENSCHED_H
 ...
 */
//class PIFOVlanEtherTrafGenSched: public cSimpleModule, public IClockListener {

class PIFOVlanEtherTrafGenSched: public VlanEtherTrafGenSched {
protected:

    /** Current schedule. Is never null. */
    std::unique_ptr<PIFOHostSchedule<Ieee8021QCtrl>> currentSchedule;

    /**
     * Next schedule to load after the current schedule finishes it's cycle.
     * Can be null.
     */
    std::unique_ptr<PIFOHostSchedule<Ieee8021QCtrl>> nextSchedule;
