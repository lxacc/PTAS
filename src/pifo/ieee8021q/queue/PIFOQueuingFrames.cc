...
#include "pifo/ieee8021q/queue/PIFOQueuingFrames.h"
...
Define_Module(PIFOQueuingFrames);

void PIFOQueuingFrames::initialize() {
...
void PIFOQueuingFrames::handleMessage(cMessage *msg) {
