...
MAKEMAKE_OPTIONS = -f --deep -o pifo -O out -KINET_PROJ=../../inet -KNESTING_PROJ=../../nesting -DINET_IMPORT -I$$\(INET_PROJ\)/src -I$$\(NESTING_PROJ\)/simulations -I$$\(NESTING_PROJ\)/src -L$$\(INET_PROJ\)/src -L$$\(NESTING_PROJ\)/src -L../out/$$\(CONFIGNAME\)/src -lINET$$\(D\) -lnesting$$\(D\)
###
