...
#ifndef PIFO_COMMON_SCHEDULE_PIFOSCHEDULEFACTORY_H_
#define PIFO_COMMON_SCHEDULE_PIFOSCHEDULEFACTORY_H_
 ...
 */
class PIFOScheduleFactory final {
public:
    /**
    ...
    static PIFOSchedule<GateBitvector>* createGateBitvectorSchedule(cXMLElement *xml);

    static PIFOSchedule<GateBitvector>* createGateSchedule(cXMLElement *xml);

    /**
     * Creates a schedule containing one entry that opens all gates for the whole cycle duration
     */
    static PIFOSchedule<GateBitvector>* createDefaultBitvectorSchedule(cXMLElement *xml);

    static PIFOSchedule<SendDatagramEvent>* createDatagramSchedule(cXMLElement *xml);
private:
